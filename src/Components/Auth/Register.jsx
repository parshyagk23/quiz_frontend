...
const Register = ({ setisLogin }) => {
  ...
  const handleOnchange = (e) => {
    setError({ username: "", email: "", password: "", confirmPassoword: "" });
  ...
  const handleRegister = async () => {
    ...
    if (
      ...
      RegisterData.password !== RegisterData.confirmPassoword
    ) {
      setError((prev) => {
    ...
    if (
      RegisterData.confirmPassoword.trim().length == 0 ||
      RegisterData.password !== RegisterData.confirmPassoword
    ) {
      setError((prev) => {
    ...
    <>
      ...
      <main className={styles.auth}>
        ...
        <div>
          ...
          <input
            style={
              error.confirmPassoword === "password does'nt match"
                ? { border: "1px solid red" }
                : {}
            }
